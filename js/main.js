...
(function () {
  ...
  if (marqueeInner) {
    const items = [
      'Turquía', 'Tailandia', 'Londres', 'Puerto Vallarta',
      'Grecia', 'Capadocia', 'Viajes en Grupo', 'Luna de Miel',
      'Asesoría Personalizada', 'Paga a Meses', 'Salidas Todo el Año', 'Cotiza por WhatsApp'
    ];
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      if (!name || !message) {
        showFormError('Por favor completa tu nombre y cuéntanos tu viaje ideal.');
        return;
      }
